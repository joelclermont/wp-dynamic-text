...
// these are the short codes that will be handled by this plugin
$dt_shortcodes = array(
	'phone',
	'city',
);
...
//
// TODO: move this into a more sane data structure (in a database)
$dt_params = array(
	'user'	=> array( //first level
		'joel'    => array( //second level
			'phone' => 'aaa-bbb-cccc', //third level -> matches 'phone' from $dt_shortcodes
			'city'  => 'Grafton', //third level -> matches 'city' from $dt_shortcodes
		),
		'scott'   => array( //second level
			'phone' => 'xxx-yyy-zzzz',
			'city'  => 'Brookfield',				
		),
	),
